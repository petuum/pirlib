...
@task(enable_cache=True, cache_key_fn=generate_preprocess_key)
...
@task(enable_cache=True, cache_key_fn=generate_train_key)
...
@task(enable_cache=True, cache_key_fn=generate_key)
def postprocess(
