...
def read_wiki_task(base_input_dir: DirectoryPath) -> DirectoryPath:
    ...
    redirects = get_path(base_input_dir, "redirects_en.tql.bz2")
    nif_context = get_path(base_input_dir, "nif_context_en.tql.bz2")
...
def add_link_info(
    ...
    output_dir = task.context().output
    redirects = get_path(base_input_dir, "redirects_en.tql.bz2")
    nif_text_links = get_path(base_input_dir, "nif_text_links_en.tql.bz2")
...
def add_property_info(
    ...
    output_dir = task.context().output
    redirects = get_path(base_input_dir, "redirects_en.tql.bz2")
    info_boxs_properties = get_path(base_input_dir, "infobox_properties_mapped_en.tql.bz2")
...
def add_literal_info(
    ...
    output_dir = task.context().output
    redirects = get_path(base_input_dir, "redirects_en.tql.bz2")
    mapping_literals = get_path(base_input_dir, "mappingbased_literals_en.tql.bz2")
...
def add_object_info(
    ...
    output_dir = task.context().output
    redirects = get_path(base_input_dir, "redirects_en.tql.bz2")
    mapping_objects = get_path(base_input_dir, "mappingbased_objects_en.tql.bz2")
...
def add_category_info(
    ...
    output_dir = task.context().output
    redirects = get_path(base_input_dir, "redirects_en.tql.bz2")
    categories = get_path(base_input_dir, "article_categories_en.tql.bz2")
